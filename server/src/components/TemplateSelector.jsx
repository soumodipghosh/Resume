...
const TemplateSelector = ({selectedTemplate, onChange}) => {
  ...
  return (
    <div className='relative'>
      <button onClick={() => setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-blue-600 bg-white hover:ring transition-all px-3 py-2 rounded-lg cursor-pointer'>
        <Layout size={14}/>
